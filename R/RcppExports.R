...
SolveTenPuzzle <- function(x, tgt, findone, useup, intonly, nonnegative, nonzero) {
    .Call('_tenpuzzle_SolveTenPuzzle', PACKAGE = 'tenpuzzle', x, tgt, findone, useup, intonly, nonnegative, nonzero)
}
