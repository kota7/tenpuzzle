...
SolveTenPuzzle <- function(x, tgt, findone, useall, intonly, nonnegative, nonzero) {
    .Call('_tenpuzzle_SolveTenPuzzle', PACKAGE = 'tenpuzzle', x, tgt, findone, useall, intonly, nonnegative, nonzero)
}
